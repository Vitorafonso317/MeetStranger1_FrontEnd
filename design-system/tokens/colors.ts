...
export const lightTheme: ColorTokens = {
  ...
  // Paleta azul clara
  primary: '#47a9db',      // Azul principal
  primaryLight: '#DBEAFE', // Azul claro
  primaryDark: '#0e3448',  // Azul escuro
  secondary: '#E0F2FE',    // Azul secundário

  // Fundos claros
  background: '#fff9ee',   // Fundo geral
  surface: '#FFFFFF',      // Superfícies
  surfaceElevated: '#F8FAFC', // Elementos elevados

  // Hierarquia de texto
  textPrimary: '#6b000a',  // Texto principal
  textSecondary: '#0e3448',// Texto secundário
  textTertiary: '#00496e', // Texto discreto
